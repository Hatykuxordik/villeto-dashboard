...
function Router() {
  return (
    <Switch>
      ...
      <Route path={"/new-report"} component={() => <DashboardLayout><UploadReceipt /></DashboardLayout>} />
      <Route path={"/new-report/details"} component={() => <DashboardLayout><ExpenseDetailsForm /></DashboardLayout>} />
